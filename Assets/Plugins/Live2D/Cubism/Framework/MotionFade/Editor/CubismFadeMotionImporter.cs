...
namespace Live2D.Cubism.Framework.MotionFade
{
    internal static class CubismFadeMotionImporter
    {
        ...
        private static async UniTask OnModelImport(CubismModel3JsonImporter importer, CubismModel model)
        {
            ...
            if ((await importer.GetModel3JsonAsync()).FileReferences.Motions.Motions == null || fadeController == null)
            {
                return;
            }
