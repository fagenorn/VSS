...
namespace Live2D.Cubism.Editor.Importers
{
    public sealed class CubismExpression3JsonImporter : CubismImporterBase
    {
        ...
        private static void RegisterImporter()
        {
            ...
            CubismImporter.OnDidImportModel += OnModelImportAsync;
        }
        ...
        /// </summary>
        public override UniTask ImportAsync()
        {
        ...
        private static async UniTask OnModelImportAsync(CubismModel3JsonImporter importer, CubismModel model)
        {
            var expressionController = model.GetComponent<CubismExpressionController>();
            if (expressionController == null || (await importer.GetModel3JsonAsync()).FileReferences.Expressions == null)
            {
                return;
            }
