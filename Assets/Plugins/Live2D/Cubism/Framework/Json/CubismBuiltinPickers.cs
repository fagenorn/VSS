...
namespace Live2D.Cubism.Framework.Json
{
    ...
    public static class CubismBuiltinPickers
    {
        ...
        /// <param name="drawable">Drawable to map to.</param>
        /// <returns>Mapped texture.</returns>
        public static async UniTask<Texture2D> TexturePickerAsync(CubismModel3Json sender, CubismDrawable drawable)
        {
            return (await sender.GetTexturesAsync())[drawable.TextureIndex];
        }
    }
}
