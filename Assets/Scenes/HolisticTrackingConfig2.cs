...
{
  public class HolisticTrackingConfig2 : ModalContents
  {
    ...
    private HolisticTrackingSolution2 _solution;
    ...
    private void Start()
    {
      _solution = GameObject.Find("tracking").GetComponent<HolisticTrackingSolution2>();
      InitializeContents();
    }
